...
const Form = () => {
  ...
  try {
    ...
    ooe(
      ...
      "66be797597b63667bc01ac79",
      null,
      "oo-embed-form-pel-karet-4719",
      {
        mode: "page",
    ...
    <div>
      <div className="ooef">
        <form
          ...
          data-product-slug="pel-karet"
          data-product-id="66be797597b63667bc01ac79"
          id="oo-embed-form-pel-karet-4719"
